...
[Review Candidates](../how-to/review-candidates/) for the procedure.
...
The [Handoff Report](../how-to/use-handoff-report/) projects current Handoff Revisions for inspection and export. The
...
Use [Interfaces](../reference/interfaces/) for current surface availability and
[Configuration](../reference/configuration/) for exact settings and defaults. RFCs record design decisions and may
